          ...
          <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 -mt-2">
            <div class="lg:col-span-4 bg-[#2A3FA1] p-6 flex flex-col items-center relative h-full shadow-[-10px_-10px_0px_#441563]">
              ...
              <div class="w-full flex flex-col gap-3">
                <button class="bg-[#441563] font-bold hover:scale-105 duration-300 text-[#f2f2f2] flex items-center gap-3 px-6 py-3 cursor-pointer rounded-full">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                  Personal information
                </button>    
                <button class="bg-[#f2f2f2] rounded-full font-bold px-6 py-3 flex items-center gap-3 text-[#441563] cursor-pointer hover:scale-105 duration-300 ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                  ...
                  <form class="flex flex-col gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="password" placeholder="your current password" class="w-full bg-[#441563] border border-transparent focus:border-purple-400 rounded-full px-4 py-3 text-sm placeholder-gray-400 outline-none transition-all">
                    </div>
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold ml-1">New password:</label>
                        <input type="password" placeholder="your new password" class="w-full bg-[#441563] border border-transparent focus:border-purple-400 rounded-full px-4 py-3 text-sm placeholder-gray-400 outline-none transition-all">
                    </div>
                    <div class="space-y-2">
                        <label class="block text-sm font-semibold ml-1">Confirm new password:</label>
                        <input type="password" placeholder="confirm your new password" class="w-full bg-[#441563] border border-transparent focus:border-purple-400 rounded-full px-4 py-3 text-sm placeholder-gray-400 outline-none transition-all">
                    </div>
                  </form>
